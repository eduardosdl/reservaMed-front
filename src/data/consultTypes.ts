export const consultTypes = [
  ...
  { value: 'PRENATAL', label: 'Consulta Pré-Natal' },
  { value: 'PEDIATRIC', label: 'Consulta Pediátrica' },
  { value: 'PSYCHIATRIC', label: 'Consulta Psiquiátrica/Psicológica' },
  { value: 'DENTAL', label: 'Consulta Odontológica' },
